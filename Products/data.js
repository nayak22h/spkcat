window.productsData = {
    "products": {
        "product1": {
            "name": "Tek-Plast AC Plus",
            "description": "Tek-Plast AC Plus is a single component acrylic color plaster specially formulated from selected acrylic co-polymers, binders, pigments, sand, admixtures and aggregates. Plastering application on all kinds of internal & external building surfaces.",
            "images": [
                "https://placehold.co/800x400?text=TekplastACplus+Image+1",
        ...
        "product3": {
            "name": "Tek-Plast CL",
            "description": "Tek-Plast CL is a single component cementitious colour plaster specially formulated from selected cements, pigments, sand, admixtures and aggregates. Plastering application for use on all kinds of internal & external building surfaces. ",
            "images": [
                "https://placehold.co/800x400?text=TekplastCL+Image+1",
        ...
        "product4": {
            "name": "Tek-Plast CP",
            "description": "Tek-Plast CP is a single component cementitious plaster specially formulated from selected cements, sand, admixtures and aggregates. Plastering application for use on all kinds of internal & external building surfaces. ",
            "images": [
        ...
        "product10": {
            "name": "Tek-Bond EP",
            "description": "TEK-BOND EP is a solvent-free epoxy bonding agent and adhesive containing acid resistant fillers and wetting agents; for the bonding of old concrete to new concrete/render.",
            "images": [
        ...
        "product14": {
            "name": "Tek-Bind RC",
            "description": "Tek-Bind RC Rush coat is a dry pre-mixed polymer modified sand cement bond coat used to provide a mechanical key for cement and gypsum plaster. The use of this product eliminates the need for hacking or chipping of the concrete surface before application of the plaster. ",
            "images": [
        ...
        "product25": {
            "name": "Tek-Crete EFC",
            "description": "Tek-Crete EFC is a multi-component epoxy resin based putty specially formulated from graded fillers and non-sagging agents which makes it ideal for application on vertical surfaces.",
            "images": [
                "https://i.postimg.cc/DzxMb4BM/Tekcrete-EFC.png",
        ...
        "product46": {
            "name": "Tek-Grout EG",
            "description": "Tek-Grout EG is a two component epoxy tile grout based on a high grade epoxy resin system with superior chemical resistance and hygienic properties.",
            "images": [
                "https://i.postimg.cc/q7GrGHtB/Tek-grout-EG-part-A-5kg.jpg",
                "https://i.postimg.cc/HxsgZv5w/tek-grout-EG-part-b-5kg.jpg",
        ...
        "product50": {
            "name": "Tek-Tile ATA",
            "description": "Tek-Tile ATA is a single component 'ready-to-use' acrylic tile adhesive based on a high polymer system with superior adhesion, high strength for dry areas in interior application. It can be applied on a variety of substrates. ",
            "images": [
        ...
        "product53": {
            "name": "Tek-Tile GP",
            "description": "Tek-Tile GP is a single component cementitious tile adhesive based on a high polymer system with superior adhesion, high strength for dry areas in interior & exterior application. It can be applied on a variety of substrates",
            "images": [
                "https://i.postimg.cc/T2jSfyJ5/Tile-Glue-Mortar-20kg.jpg",
                "https://i.postimg.cc/tTSHLdtL/Tek-tile-glue-white-20kg.jpg",
        ...
        "product57": {
            "name": "Tek-Tile HP",
            "description": "Tek-Tile HP is a two component cementitious tile adhesive based on a high polymer system with superior adhesion, high strength, and interior & exterior application properties. It can be applied on all variety natural substrates in wet conditions. ",
            "images": [
        ...
        "product69": {
            "name": "Tek-Screed LTW",
            "description": "Tek-Screed LTW is a cementitious premixed ready to use product when mixed with water to produce light weight concrete mix for a variety of applications. ",
            "images": [
                "https://i.postimg.cc/Fz0RRvND/tekscreed-LTW.png"
            ],
            "catalogLink": "../path/to/Tek-Screed LTW.pdf"
        },
        "product70": {
            "name": "Tek-Grip Aggregate",
            "description": "Tek-Grip Aggregate is processed silica sand. They are used to create anti-slip finish with Tek-Floor car park protective coating systems. It is also used to provide suitable primed surface to create key on smooth surfaces for the application of trowel applied screeds. ",
            "images": [
                "https://i.postimg.cc/SNmCH1yc/Tek-grip-aggregate.png"
            ],
            "catalogLink": "../path/to/Tek-Grip Aggregate.pdf"
        },
        "product116": {
            "name": "Tek-Bond GJC (Gypsum Joint Compound)",
            "description": "Tek-Bond GJC is a pre-mixed gypsum co-polymer modified jointing compound with graded fillers used for filling and finishing plasterboard joints prior to painting systems.",
            "images": [
                "https://i.postimg.cc/ZYj5Ppkt/gypsum-joint-compound-28kg-full.jpg",
        ...
        "product118": {
            ...
            "images": [],
            "catalogLink": "../path/to/Tek-Screed 20 C.pdf"
        },
        "product119": {
            "name": "Tek-Screed 30 C - new",
            "description": "Tek-Screed 30 C is a cementitious floor screed.",
            "images": [],
            "catalogLink": "../path/to/Tek-Screed 30 C.pdf"
        },
        "product120": {
            "name": "Tek-Screed 40 C - new",
            "description": "Tek-Screed 40 C is a cementitious floor screed.",
            "images": [],
            "catalogLink": "../path/to/Tek-Screed 40 C.pdf"
        },
        "product121": {
            "name": "Tek-Screed 50 C - new 2",
            "description": "Tek-Screed 50 C is a cementitious floor screed.",
            "images": [],
            "catalogLink": "../path/to/Tek-Screed 50 C.pdf"
        },
        "product117": {
            "name": "Tek-Fill ST",
            "description": "Tek-Fill ST Stucco filler is a pre-mixed styrene acrylic co-polymer modified putty with graded fillers used to provide a undercoat leveller prior to painting systems. ",
            "images": [
        ...
        "product167": {
            "name": "Tek-Floor FHQ",
            "description": "Tek-Floor FHQ is quartz based and designed to provide high strength concrete floor hardener. Fresh concrete floors treated with Tek-Floor FHQ will be resistant to chemical, spalling, deterioration and surface abrasion.",
            "images": [],
            "catalogLink": "../path/to/Tek-Floor FHQ.pdf"
        },
        "product168": {
            "name": "Tek-Floor FHS",
            "description": "Tek-Floor FHS is silica based and designed to provide high strength concrete floor hardener. Fresh concrete floors treated with Tek-Floor FHS will be resistant to chemical, spalling, deterioration and surface abrasion.",
            "images": [],
            "catalogLink": "../path/to/Tek-Floor FHS.pdf"
        },
        "product169": {
            "name": "Tek-Floor SL 10-30",
            "description": "Tek-Floor SL 10-30 is a polymer modified single component self-leveling screed. The material has been specially formulated to provide a smooth crack-free leveled surface.",
            "images": [],
        ...
        "product171": {
            ...
            "description": "Tek-Floor SL 10-70 is a polymer modified single component self-leveling screed. The material has been specially formulated to provide a smooth crack-free leveled surface.",
            "images": [],
            "catalogLink": "../path/to/Tek-Floor SL 10-70.pdf"
        },
        "product172": {
            "name": "Tek-Floor SL HS",
            "description": "Tek-Floor SL HS is a polymer modified high strength single component self-leveling underlay screed. The material has been specially formulated to provide a smooth crack-free leveled surface.",
            "images": [],
        ...
        "product174": {
            ...
            "description": "Tek-Inlay Crystal is a dry premix, decorative finish for internal and external use, giving a premium surface finish.\nA seamless finish suitable for walls, floors, ceilings, kitchen countertops, artistic installations and tested and approved for submerged wet areas such as showers, wet rooms, swimming pools and spas. Tek-Inlay Crystal is also suitable for low speed vehicle traffic.\nTek-Inlay crysta...",
            "images": [],
            "catalogLink": "../path/to/Tek-Inlay Crystal.pdf"
        },
        "product175": {
            "name": "Tek-Floor Deck",
            "description": "Tek-Floor Deck is a multi-component high quality elastomeric intermediate polyurethane resin based wearing coat for car park deck coating system. Tek-Floor Deck is designed to provide a flexible and crack bridging waterproof coating for highly trafficked areas.",
            "images": [],
            "catalogLink": "../path/to/Tek-Floor Deck.pdf"
        },
        "product176": {
            "name": "Tek-Floor FHL",
            "description": "Tek-Floor FHL is a clear liquid solution of metallic magnesium silica fluoride and penetrating agent. Tek-Floor FHL reacts chemically with the free lime present in the hardened concrete making it more dense, dust proof and makes it resistant to chemicals and abrasion.",
            "images": [],
            "catalogLink": "../path/to/Tek-Floor FHL.pdf"
        },
        "product177": {
            "name": "Tek-Floor PU",
            "description": "Tek-Floor PU is a high performance solvent free polyurethane system specially developed for use as a high build flexible waterproofing decking membrane.\nTek-Floor PU is formulated on a complex blend of high molecular weight polyols and urethane polymers, which produces a sysyem with outstanding impact and chemical resistance with a high degree of flexibility. The special blend pigments enables a s...",
            "images": [],
            "catalogLink": "../path/to/Tek-Floor PU.pdf"
        },
        "product178": {
            "name": "Tek-Floor SB",
            "description": "Tek-Floor SB is a two component solvent based epoxy resin based coating for concrete and metal surfaces. This coating provides a protection to both cementatious and metal surfaces against abrasion and light to medium chemical spillages.",
            "images": [],
            "catalogLink": "../path/to/Tek-Floor SB.pdf"
        },
        "product179": {
            "name": "Tek-Floor SF",
            "description": "Tek-Floor SF is a two component solvent-free high performance ceramic enhanced, high build epoxy floor coating. It is designed to provide high abrasion resistance and protection against chemical attack. These superior",
            "images": [],
            "catalogLink": "../path/to/Tek-Floor SF.pdf"
        },
        "product180": {
            "name": "Tek-Floor UVR",
            "description": "Tek-Floor UVR is a two component solvent-base high performance, high build polyurethane floor coating. It is designed to provide high abrasion resistance and protection against UV light. These superior",
            "images": [],
            "catalogLink": "../path/to/Tek-Floor UVR.pdf"
        },
        "product181": {
            "name": "Tek-Floor WB",
            "description": "Tek-Floor WB is a high performance water based coating designed for use as a cost effective durable floor protection system. Tek-Floor WB consists of a unique blend of water dispesable epoxy resin combined with hydrophilic amine adducts reinforced with ceramic particles that is specially selected to produce a tough durable coating with optimum level of adhesion, abrasion , impact and chemical resi...",
            "images": [],
            "catalogLink": "../path/to/Tek-Floor WB.pdf"
        },
        "product182": {
            "name": "Tek-Screed ES Epoxy Screed",
            "description": "Tek-Screed ES epoxy screed is a three component, trowel grade, heavy duty, floor topping consisting of epoxy resin, hardener and graded quartz filler. The product gives excellent mechanical",
            "images": [],
            "catalogLink": "../path/to/Tek-Screed ES Epoxy Screed.pdf"
        },
        "product183": {
            "name": "Tek-Screed PU Screed",
            "description": "Tek-Screed PU Screed is a polyurethane based screed suitable for",
            "images": [],
            "catalogLink": "../path/to/Tek-Screed PU Screed.pdf"
        },
        "product184": {
            "name": "Tek-Screed SS PU Topping",
            "description": "Tek-Screed SS PU Topping is a polyurethane based self-smoothening topping suitable for",
            "images": [],
            "catalogLink": "../path/to/Tek-Screed SS PU Topping.pdf"
        },
        "product185": {
            "name": "Tek-Screed SS",
            "description": "Tek-Screed SS is a three component solvent-free high performance ceramic enhanced, high build epoxy self-\nsmoothing floor screed. It is designed to provide high abrasion resistance and protection against chemical attack. Tek-Screed SS available in two grades:\n\u00a4\u00a4 SL 2, thickness: 1 to 2mm\n\u00a4\u00a4 SL 4, thickness: 2 to 4mm",
            "images": [],
            "catalogLink": "../path/to/Tek-Screed SS.pdf"
        },
        "product186": {
            "name": "Tek-Screed SS1",
            "description": "Tek-Screed SS1 consists of a special resin and graded aggregates formulated to withstand chemical attack and impact shock. The product is supplied as a three component system comprising of base, resin hardener and filler. It provides a surface ready to receive",
            "images": [],
            "catalogLink": "../path/to/Tek-Screed SS1.pdf"
        },
        "product187": {
            "name": "Tek-Seal SF",
            "description": "Tek-Seal SF is a two component solvent-free high performance, high build epoxy clear sealer suitable for use with a wide range of epoxy coatings systems.",
            "images": [],
